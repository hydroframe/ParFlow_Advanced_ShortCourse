...
# problem 3, uniform, heterogeneous block in middle of domain
#
#
...
#-----------------------------------------------------------------------------
pfset GeomInput.Names "domain_input block_input"
...
#-----------------------------------------------------------------------------
# Block Geometry Input
#-----------------------------------------------------------------------------
pfset GeomInput.block_input.InputType            Box
pfset GeomInput.block_input.GeomName             block

#-----------------------------------------------------------------------------
# Domain Geometry
#-----------------------------------------------------------------------------
pfset Geom.block.Lower.X                        200.0 
pfset Geom.block.Lower.Y                        200.0
pfset Geom.block.Lower.Z                          20.0

pfset Geom.block.Upper.X                        300.0
pfset Geom.block.Upper.Y                        300.
pfset Geom.block.Upper.Z                        30.

#-----------------------------------------------------------------------------
# Perm
#-----------------------------------------------------------------------------
pfset Geom.Perm.Names "domain block"

pfset Geom.domain.Perm.Type        Constant
pfset Geom.domain.Perm.Value       1.0

pfset Geom.block.Perm.Type        Constant
pfset Geom.block.Perm.Value       10.00
pfset Geom.block.Perm.Value       1.00
pfset Geom.block.Perm.Value       0.1
pfset Geom.block.Perm.Value       0.01
pfset Geom.block.Perm.Value       0.001
pfset Geom.block.Perm.Value       0.0001
