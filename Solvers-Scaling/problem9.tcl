# Problem9.  This runs a test case with the Richards' solver
# with simple flow domains, it varies the nonlinear solver properties
# and the linear preconditioner for an easy (homogeneous) and a hard
...
#-----------------------------------------------------------------------------
puts stdout "Running with PFMG, True Jacobian, PFSymmetric"
pfrun problem9.PFMG.JT.Sym
pfundist problem9.PFMG.JT.Sym

puts stdout "Running with PFMG, True Jacobian, FullJacobian"
pfrun problem9.PFMG.JT.NSym
pfundist problem9.PFMG.JT.NSym
pfset Solver.Linear.Preconditioner.PCMatrixType          FullJacobian

puts stdout "Running with MGSemi, True Jacobian, PFSymmetric"
pfset Solver.Linear.Preconditioner                       MGSemi
pfset Solver.Linear.Preconditioner.PCMatrixType          PFSymmetric
pfrun problem9.MGSemi.JT.Sym
pfundist problem9.MGSemi.JT.Sym

puts stdout "Running with SMG, True Jacobian, PFSymmetric"
pfset Solver.Linear.Preconditioner                       SMG
pfset Solver.Linear.Preconditioner.PCMatrixType          FullJacobian
pfset Solver.Linear.Preconditioner.SymmetricMat          NonSymmetric
pfrun problem9.SMG.JT.NSym
pfundist problem9.SMG.JT.NSym

puts stdout "Running with MGSemi, FD Jacobian, PFSymmetric"
pfset Solver.Linear.Preconditioner                       MGSemi
pfset Solver.Linear.Preconditioner.PCMatrixType          PFSymmetric
pfset Solver.Nonlinear.UseJacobian                       False
pfrun problem9.MGSemi.FT.Sym
pfundist problem9.MGSemi.FT.Sym

puts stdout "Running with PFMG, True Jacobian, PFSymmetric"
pfset Solver.Linear.Preconditioner                       PFMG
pfset Solver.Linear.Preconditioner.PCMatrixType          PFSymmetric
pfset Solver.Nonlinear.UseJacobian                       False
pfrun problem9.PFMG.FT.Sym
pfundist problem9.PFMG.FT.Sym

# harder problem
pfset Geom.domain.Perm.Type "TurnBands"

puts stdout "Running with PFMG, True Jacobian, PFSymmetric, Harder"
pfset Solver.Nonlinear.UseJacobian                       True
pfrun problem9.PFMG.JT.Sym.H
pfundist problem9.PFMG.JT.Sym.H

puts stdout "Running with PFMG, True Jacobian, FullJacobian, Harder"
pfrun problem9.PFMG.JT.NSym.H
pfundist problem9.PFMG.JT.NSym.H
pfset Solver.Linear.Preconditioner.PCMatrixType          FullJacobian

puts stdout "Running with MGSemi, True Jacobian, PFSymmetric, Harder"
pfset Solver.Linear.Preconditioner                       MGSemi
pfset Solver.Linear.Preconditioner.PCMatrixType          PFSymmetric
pfrun problem9.MGSemi.JT.Sym.H
pfundist problem9.MGSemi.JT.Sym.H

puts stdout "Running with SMG, True Jacobian, PFSymmetric, Harder"
pfset Solver.Linear.Preconditioner                       SMG
pfset Solver.Linear.Preconditioner.PCMatrixType          FullJacobian
pfset Solver.Linear.Preconditioner.SymmetricMat          NonSymmetric

pfrun problem9.SMG.JT.NSym.H
pfundist problem9.SMG.JT.NSym.H

puts stdout "Running with MGSemi, FD Jacobian, PFSymmetric, Harder"
pfset Solver.Linear.Preconditioner                       MGSemi
pfset Solver.Linear.Preconditioner.PCMatrixType          PFSymmetric
pfset Solver.Nonlinear.UseJacobian                       False
pfrun problem9.MGSemi.FT.Sym.H
pfundist problem9.MGSemi.FT.Sym.H

puts stdout "Running with PFMG, True Jacobian, PFSymmetric, Harder"
pfset Solver.Linear.Preconditioner                       PFMG
pfset Solver.Linear.Preconditioner.PCMatrixType          PFSymmetric
pfset Solver.Nonlinear.UseJacobian                       False
pfrun problem9.PFMG.FT.Sym.H
pfundist problem9.PFMG.FT.Sym.H
