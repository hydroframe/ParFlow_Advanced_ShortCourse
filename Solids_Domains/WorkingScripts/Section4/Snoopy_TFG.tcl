...
set runname snoopy_tfg

set Top [pfload -pfb "Snoopy_Top_TFG.pfb"]
set Bot [pfload -pfb "Snoopy_Bot_TFG.pfb"]
...
pfpatchysolid -top $Top -bot $Bot -pfsol "solid_snoopy_enhanced_tfg.pfsol" -msk $EMsk -vtk "solid_snoopy_enhanced_tfg.vtk" 
# pfpatchysolid -top $Top -bot $Bot -pfsol "solid_snoopy_enhanced_tfg.pfsol" -msk $EMsk -vtk "solid_snoopy_enhanced_tfg.vtk" -sub
...
pfset GeomInput.solidinput.FileName    solid_snoopy_enhanced_tfg.pfsol
...
# Usually wise to distribute copies of files so the originals don't get messed up...
file copy -force "Snoopy_Top.pfb" "Top_Surf.pfb"
