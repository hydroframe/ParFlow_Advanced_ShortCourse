...
set runname super_slab_tfg

file mkdir super_slabby_tfg
cd super_slabby_tfg
...
# Also, note that the terrain following grid requires nx_fac=2 to match the included DEM (NX=50 in that DEM)
# These can also be changed but the DEM won't match so your terrain will have to be flat when viewing it (the problem is unchanged though, it's still SuperSlab)
...
pfset ComputationalGrid.NZ                      [expr 100/int($nz_fac)]
...
pfset GeomInput.domain_input.FileName   ../SuperSlab_Domain_TFG.pfsol
...
pfset GeomInput.slab1_input.FileName   ../SuperSlab_Slab1_TFG.pfsol
...
pfset GeomInput.slab2_input.FileName   ../SuperSlab_Slab2_TFG.pfsol
...
# This adds the surface to the PF metadata file
file copy -force "../SuperSlab_DEM.pfb" "Top_Surf.pfb"
